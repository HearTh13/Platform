...
<html lang="en">
    <head>
        ...
        />
        <link rel="stylesheet" href="project/styleLog.css" />
        <link
            rel="stylesheet"
    ...
    <body>
        ...
        <div class="container mt-3 mb-5" id="container">
        ...
        <div class="img-container">
            <div
                class="bg-image"
                style="background-image: url('project/Dune.jpeg')"
            ></div>
            <div
                class="bg-image"
                style="background-image: url('project/Dunkirk.jpeg')"
            ></div>
            <div
                class="bg-image"
                style="background-image: url('project/PeakyBlinders.jpeg')"
            ></div>
            <div
                class="bg-image"
                style="background-image: url('project/endgame.jpeg')"
            ></div>
        </div>
    </body>
