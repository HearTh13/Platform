...
<html lang="en">
    ...
    <body>
        ...
        <div class="jumbotron jumbotron-fluid text-white">
            <div class="container">
                <h1 class="display-8">
                    Film, acara TV tak terbatas, dan banyak lagi Tonton di mana
                    pun. Batalkan kapan pun. Siap belanja ? Daftar dan mulai
                    berbelanja film favorit mu !
                </h1>
            </div>
        ...
        <div class="img-container">
            <div
                class="bg-image"
                style="background-image: url('Dune.jpeg')"
            ></div>
            <div
                class="bg-image"
                style="background-image: url('Dunkirk.jpeg')"
            ></div>
            <div
                class="bg-image"
                style="background-image: url('PeakyBlinders.jpeg')"
            ></div>
            <div
                class="bg-image"
                style="background-image: url('endgame.jpeg')"
            ></div>
        </div>
                ...
                <div class="container text-center text-md-start mt-5">
                    ...
                    <div class="row mt-3">
                        ...
                        >
                            ...
                            <p>
                                <i class="fas fa-home me-3"></i> Klaten, Jawa
                                Tengah, Indonesia
                            </p>
                            <p>
